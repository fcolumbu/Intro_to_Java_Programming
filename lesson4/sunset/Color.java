...
public class Color
{
    ...
    /**
     * Makes the color redder, but not redder than 255.
     * @param addedRed is the amount of added redness
     */
    public void redden(int addedRed)
    {

        // TODO
        // final int ADDED_RED = 25;
        final int MAX_RED = 255;
        this.red = Math.min((this.red+addedRed), MAX_RED);
